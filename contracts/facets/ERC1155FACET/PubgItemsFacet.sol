...
contract PubgItems {
    function testing(address a) external view returns (address) {
        return a;
    }
    // function createCollection(uint256 _quantityOfToken, uint256 _collectionMintingFees) public {
    //         createCollection(_quantityOfToken, _collectionMintingFees);
    ...
    */
    ...
    //     bytes calldata _data
    // ) external override {
    //     LIBERC1155FACET.safeBatchTransferFrom(_from, _to, _ids, _values, _data);
    // }
    ...
    //     return LIBERC1155FACET.balanceOf(_owner, _id);
    // }
    ...
    //     return LIBERC1155FACET.balanceOfBatch(_owners, _ids);
    // }
    ...
    //     LIBERC1155FACET.setApprovalForAll(_operator, _approved);
    // }
    ...
    //     return LIBERC1155FACET.isApprovedForAll(_owner, _operator);
    // }
}
